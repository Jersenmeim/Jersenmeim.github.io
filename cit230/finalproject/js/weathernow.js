const manila = new XMLHttpRequest ();
manila.open("GET", "https://api.openweathermap.org/data/2.5/weather?id=1701668&appid=c4f26b47558cfc6a6aebf07554d017ad&units=imperial", true);
manila.send();
manila.onload = function () {

	let weatherInfo = JSON.parse (manila.responseText);
